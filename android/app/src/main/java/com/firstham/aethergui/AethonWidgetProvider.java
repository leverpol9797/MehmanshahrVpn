...
public final class AethonWidgetProvider extends AppWidgetProvider {
    private static final String TAG = "AethonWidget";
    ...
    @Override public void onReceive(Context context, Intent intent) {
        ...
        if ("connected".equals(state)) {
            ...
            if (!"manual".equals(preferences.getString("mode", "vpn")) && VpnService.prepare(context) != null) {
                Intent launch = new Intent(context, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP).putExtra(AethonTileService.EXTRA_CONNECT_FROM_TILE, true);
    ...
    static void update(Context context) {
        ...
        ComponentName name = new ComponentName(context, AethonWidgetProvider.class);
        ...
        views.setImageViewResource(R.id.widget_logo, R.drawable.ic_aethon_mono);
        ...
        Intent toggle = new Intent(context, AethonWidgetProvider.class).setAction(ACTION_WIDGET_TOGGLE).putExtra(EXTRA_TOGGLE_TOKEN, toggleToken(context));
